...
def main() -> None:
    ...
    checks["parmesan_4"] = {
        ...
        "quickstart_commands": all(command in pm4_quickstart for command in ("parmesan pm4 initialize", "parmesan pm4 orient", "parmesan pm4 fork", "parmesan pm4 compose", "parmesan pm4 share", "parmesan pm4 plan-piece", "parmesan pm4 share-piece", "parmesan pm4 receive", "parmesan pm4 mode-set")),
